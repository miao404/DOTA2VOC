...
if __name__ == '__main__':
    data_path = 'D:/Code/DOTA/DOTAship/imageSplit'
    images_path = os.path.join(data_path)  # 样本图片路径
    labeltxt_path = os.path.join('D:/Code/DOTA/DOTAship/labelTxtSplit')  # DOTA标签的所在路径
    anno_new_path = os.path.join('D:/Code/DOTA/DOTAship/Annotation')  # 新的voc格式存储位置（hbb形式）
    ext = '.png'  # 样本图片的后缀
